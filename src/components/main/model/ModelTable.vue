    ...
    draw_init: function(){
      ...
      this.$http.post(`http://10.112.120.61:8000/ResourcePool/findAreaInformation`, data).then(
        response => {
          ...
          if (status === 200 && ok) {
              var mydata = [
                {name: '北京',value: body[0] },{name: '天津',value: body[1] },
                {name: '上海',value: body[2] },{name: '重庆',value: body[3] },
                {name: '河北',value: body[4] },{name: '河南',value: body[5] },
                {name: '内蒙古',value: body[6] },{name: '辽宁',value: body[7] },
                {name: '黑龙江',value: body[8] },{name: '湖南',value: body[9] },
                {name: '安徽',value: body[10] },{name: '山东',value: body[11] },
                {name: '新疆',value: body[12] },{name: '江苏',value: body[13] },
                {name: '浙江',value: body[14] },{name: '江西',value: body[15] },
                {name: '湖北',value: body[16] },{name: '广西',value: body[17] },
                {name: '甘肃',value: body[18] },{name: '山西',value: body[19] },
                {name: '云南',value: body[20] },{name: '陕西',value: body[21] },
                {name: '吉林',value: body[22] },{name: '福建',value: body[23] },
                {name: '贵州',value: body[24] },{name: '广东',value: body[25] },
                {name: '青海',value: body[26] },{name: '西藏',value: body[27] },
                {name: '四川',value: body[28] },{name: '宁夏',value: body[29] },
                {name: '海南',value: body[30] },{name: '台湾',value: body[31] },
                {name: '香港',value: body[32] },{name: '澳门',value: body[33] },{name: '南海诸岛',value: body[34]}
              ];
              var chartTitle=body[35];
              var myChart = echarts.init(document.getElementById('ec3'));
        var option = {
          title: {
            textStyle: {
          ...
          visualMap: {
            ...
            splitList: [
              {start:400},
              {start: 200, end: 400},
              {start: 100, end: 200},{start: 50, end: 100},{start: 0, end: 50},
            ],
            textStyle: {
              color: '#000'
            },
            color: ['#5475f5', '#e6ac53', '#9fb5ea','#625234','#74e2ca']
          },
